...
# Firebase removed: using local filesystem logging and datasets only
...
CONFIG = {
    ...
    "embedding_mode": "hybrid",            # landmarks | cnn | hybrid
    "embedding_component_weights": {"cnn": 1.0, "landmarks": 0.0},
...
def parallel_face_encoding(rgb_frame, face_locations):
    ...
    if use_landmarks and dlib_shape_predictor is None:
...
def main():
    ...
    if CONFIG.get("use_landmark_embeddings", True):
        initialize_dlib_shape_predictor()
